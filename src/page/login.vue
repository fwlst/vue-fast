<template>
    <section class="login">
        ...
        <div class="form">
            <mt-field label="用户名：" placeholder="请输入用户名" v-model.trim="form.userName"
                      @input="$v.form.userName.$touch()"></mt-field>
            <mt-field label="密码：" placeholder="请输入密码" type="password" v-model.trim="form.password"
                      @input="$v.form.password.$touch()"></mt-field>
        </div>
